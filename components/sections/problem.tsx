...
const problems = [
  {
    icon: EyeOff,
    text: "Most professional value remains invisible.",
  },
  {
    icon: Volume2,
    text: "Visibility depends on who speaks, not who delivers.",
  },
  {
    icon: Theater,
    text: "Employee advocacy often feels forced and artificial.",
  },
]
