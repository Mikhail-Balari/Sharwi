...
export function LiveDemoSection() {
  // Track interactions with the embedded demo iframe via postMessage
  useEffect(() => {
    let interactionTracked = false
    const handleMessage = (e: MessageEvent) => {
      // Track any message coming from the demo app (indicates user interaction)
      if (
    ...
    // Also track if user clicks inside the iframe area (focus event)
  ...
  return (
    <section id="live-demo" className="py-24" style={{ position: "relative", zIndex: 3 }}>
      ...
      {/* Exact embed implementation as specified — do NOT modify structure or sizing */}
      <div
        style={{
          display: "flex",
      ...
      >
        <div
          style={{
            ...
            boxShadow:
              "0 10px 40px rgba(0, 0, 0, 0.4), 0 0 80px rgba(255, 106, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
            overflow: "hidden",
            position: "relative",
          }}
        >
